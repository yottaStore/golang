...
const (
	...
	SizeofIoUringSqe = unsafe.Sizeof(uint32(0)) //IoUringSqe{})
	SizeofIoUringCqe = unsafe.Sizeof(uint32(0)) //IoUringCqe{})
)

type ioUringCqeArray = unsafe.Pointer
type uint32Array = unsafe.Pointer     // *uint32
type ioUringSqeArray = unsafe.Pointer // *uint32
